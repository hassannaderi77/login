...
import landImg from '../../assets/images/landscape.svg'
                ...
                <Row>
                    <Col md={6}>
                        <p className='my-5' style={{textAlign: 'justify'}}>
                            ...
                            و فرهنگ پیشرو در زبان فارسی ایجاد کرد، در این صورت 
                    ...
                    <Col md={6}>
                        <img src={landImg} className='img-fluid my-5' />
                    </Col>
                </Row>

                <Row>
                    <Col md={6}>
                        <img src={cooking} className='img-fluid my-5' />   
                    </Col>
                    <Col md={6}>
